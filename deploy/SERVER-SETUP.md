...
- `ADMIN_EMAIL` – Admin login email (default `admin@findpro.co.za`).
- `ADMIN_PASSWORD` – Admin login password (default `ChangeMe123!`). The server ensures this admin exists on startup; set it before first run.
